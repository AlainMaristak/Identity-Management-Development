...
if (isset($inputData['ip'])) {
    ...
    $url = "http://10.11.0.161:9000/scan_completo?ip=" . urlencode($ip);
        ...
        if (isset($data['data']) && is_array($data['data'])) {
            ...
            if ($ipData) {
                ...
                $formattedResponse = [
                    ...
                    'Sistema Operativo' => $ipData['osmatch'][0]['name'] ?? 'No disponible',
                    'Uptime' => $ipData['uptime']['lastboot'] ?? 'No disponible',
                    'Puertos' => []
                ];
